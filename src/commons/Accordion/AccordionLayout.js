    ...
    <>
      <div className="mb-3 rounded-b-2xl">
        <div
          ...
          className="flex justify-between w-full px-5 py-3 bg-green3/20 text-gray-600 font-bold rounded-2xl border-b border-green3 cursor-pointer"
        >
          ...
          {activeIndex === index ? (
            <div className="bg-green3 rounded-full flex justify-center items-center w-7 h-7">
              <HiOutlineChevronUp className="w-5 h-5 stroke-white" />
            </div>
          ) : (
            <div className="bg-slate-500 rounded-full flex justify-center items-center w-7 h-7">
              <HiOutlineChevronDown className="w-5 h-5 stroke-white" />
            </div>
          )}
        </div>
